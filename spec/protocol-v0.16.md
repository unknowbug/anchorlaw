...
- **Go (v0.16)**: line comments `// @anchor.test("description", source="...")`
  ...
  reference extractor (annotation-extraction).
- **Java (v0.16)**: line comments `// @anchor.test("description", source="...")`
  — same declaration site as C++; comments are inert by construction; the
...
- Current version: **v0.16** — pre-stable. All components subject to change based on practice feedback.
...
| "Go and Java anchors use line-comment declaration (`// @anchor.*`) with an independent probe/test binary as validation carrier" | §2.4/§13 (v0.16) | Reference extractor wired (same regex as C++); no real-project practice yet | ⚠️ scoped (specified; first-host practice pending) |
