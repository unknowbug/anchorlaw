...
- Current version: **v0.12** — pre-stable. All components subject to change based on practice feedback.
...
has four stages, each terminating on a "Judge nod" in the normal path (not on
round counting; [§15.4](#154-consistency-contract) C caps same-criterion
iteration at 3):
...
- **C. Judge-nod termination with mechanical fallback (v0.10; v0.12
  ...
  **Mechanical fallback (v0.12; the v0.9 round cap, restored and adapted)** —
  ...
  cap of [§9.4](#94-retry-cap-anti-entropy) is unchanged.
