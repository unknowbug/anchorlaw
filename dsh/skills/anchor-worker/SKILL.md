...
whenToUse: 流水线 stage 3 模块实施时，由 Judge 派遣（DSH 中经 subagent 工具隔离执行，上下文不进入主会话）
---

# anchor.worker — 模块实施角色（subprocess）

> Protocol: spec/protocol-v0.17.md §15.1 (Definition), §15.2 (Isolation Semantics), §15.4 (Consistency Contract)
