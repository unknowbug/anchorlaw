...
> Protocol: spec/protocol-v0.17.md §15.4 (Consistency Contract), §16 (Host Integration)
...
（v0.11 输入契约 + 四段流水线触发点，见 [协议 §15.4](spec/protocol-v0.17.md#154-consistency-contract)）：
