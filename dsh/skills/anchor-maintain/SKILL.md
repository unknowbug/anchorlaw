...
whenToUse: 在 Anchorlaw 仓库内修改协议或实现本身时（L4，仅限协议自身仓库；主会话内 inline 执行）
---

# anchor.maintain — 协议维护工作流

> Protocol: spec/protocol-v0.20.md §0 (Universal Quantifier Discipline), §8 (Maturity), §10 (Versioning), §11 (Audit)
