"""
practify — Practify Protocol full implementation (Level 2-4)

"Any claim must have a verifiable practice anchor."
"Only offense, no defense. The only allowed defense is honest ignorance."

practify is not a test framework. It is an anchoring system that elevates
tests from "optional add-ons" to "part of the type declaration."

Maturity:
  Scanner: VERIFIED (via practify-scanner dependency)
