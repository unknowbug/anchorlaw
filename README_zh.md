...
这不是防御性条款——是诚实地标注当前能做到什么。详见 [协议规范 §9](spec/protocol-v0.13.md#9-degraded-verification-v03-draft)。
...
├── spec/
│   └── protocol-v0.13.md       # 语言无关的协议规范（当前版）
├── python/
...
- [协议规范 v0.13](spec/protocol-v0.13.md)
- 唯物实践论方法论——本协议的哲学基础
